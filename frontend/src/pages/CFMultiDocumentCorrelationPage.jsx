...
// Custom Feature: Multi-document correlation
// Multi-document correlation: When multiple documents involve same parties, auto-link them and surface patterns (e.g., repeated amendments to same agreement)
import React, { useState } from 'react';

export default function CFMultiDocumentCorrelationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-document-correlation/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Multi-document correlation</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Multi-document correlation: When multiple documents involve same parties, auto-link them and surface patterns (e.g., repeated amendments to same agreement)</p>
