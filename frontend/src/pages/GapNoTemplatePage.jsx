...
export default function GapNoTemplatePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-template/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No '/template</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No /template-suggestion AI (recommend relevant form templates based on document type)</p>
