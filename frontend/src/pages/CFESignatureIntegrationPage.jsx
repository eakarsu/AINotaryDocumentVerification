...
// Custom Feature: E-signature integration
// E-signature integration: Embed DocuSign/HelloSign; auto-route documents to witness e-signature, reducing in-person visits
import React, { useState } from 'react';

export default function CFESignatureIntegrationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-e-signature-integration/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      ...
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>E-signature integration: Embed DocuSign/HelloSign; auto-route documents to witness e-signature, reducing in-person visits</p>
