...
export default function GapNoMobilePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-mobile/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No mobile</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No mobile-native app (web only with minimal mobile responsive design)</p>
