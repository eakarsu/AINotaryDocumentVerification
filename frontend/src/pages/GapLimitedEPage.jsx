...
export default function GapLimitedEPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-e/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Limited e</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Limited e-signature integration (some signature handling exists but no DocuSign/SignNow connector)</p>
