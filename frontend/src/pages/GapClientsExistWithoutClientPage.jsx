...
// Gap (AI): Clients exist without '/client
// Clients exist without /client-risk-score (detect problematic repeat customers)
import React, { useState } from 'react';

export default function GapClientsExistWithoutClientPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-clients-exist-without-client/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Clients exist without '/client</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Clients exist without /client-risk-score (detect problematic repeat customers)</p>
